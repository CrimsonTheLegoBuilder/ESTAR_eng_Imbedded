...
unsigned char Temperature[8] = { 0x5a, 0xa5, 0x05, WRITE_DATA, temperature_add, 0x00, 0x00, 0x01 };
unsigned char Humidity[8] = { 0x5a, 0xa5, 0x05, WRITE_DATA, humidity_add, 0x00, 0x00, 0x01 };
